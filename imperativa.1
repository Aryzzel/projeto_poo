...
def iniciar_figura_nova(event): 
    ...
    if tipo_figura_var.get() == 'Linha':
        ...
        figura_nova = ("circulo", (event.x, event.y, event.x))
...
def atualizar_figura_nova(event):
    ...
    if figura_nova[0] == "rabisco":
        ...
        figura_nova = ("circulo", (figura_nova[1][0], figura_nova[1][1], abs(figura_nova[1][0]+figura_nova[1][1] - (event.x+event.y))))
    elif figura_nova[0] == "oval":
        figura_nova = ("oval", (figura_nova[1][0], figura_nova[1][1], abs(figura_nova[1][0] - event.x), abs(figura_nova[1][1]- event.y)))
